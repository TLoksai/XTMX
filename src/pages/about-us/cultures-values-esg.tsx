...
const HomePage: React.FC = () => {
  return (
    <>
      ...
      {/* Our Values Section */}
      <section className="bg-[#0a0214] text-white py-16 px-6 md:px-12">
      ...
      <section className="bg-[#0a0214] text-white py-16 px-6 md:px-12">
        <div className="max-w-screen-lg mx-auto text-center">
          ...
          <p className="text-gray-300 mt-4 max-w-2xl mx-auto">
            At XTRANSMATRIX, every day is an opportunity to drive meaningful
            change for our clients, their customers, our industry, and our
            communities. We expect every team member to embrace our core
            principles:
          </p>

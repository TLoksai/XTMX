          ...
          {[ 
            {
              ...
              imgSrc: "/images/about-us(Cultures)/learnmore/future/innovation.jpg",
            },
            {
              ...
              imgSrc: "/images/about-us(Cultures)/learnmore/future/purpose3.jpg",
            },
            {
              ...
              imgSrc: "/images/about-us(Cultures)/learnmore/future/challenging2.jpg",
            },
            {
              ...
              imgSrc: "/images/about-us(Cultures)/learnmore/future/future-of-work.jpg",
            },
            {
              ...
              imgSrc: "/images/about-us(Cultures)/learnmore/future/legacy.jpg",
            },
            {
            ...
            >
              ...
              <div className="md:w-1/2 p-4 flex justify-center relative z-10">
                <img
                  src={card.imgSrc}
                  alt={card.title}
                  className="rounded-lg w-full md:w-5/6 h-60 object-cover"
                />
              </div>
            </div>
          ))}

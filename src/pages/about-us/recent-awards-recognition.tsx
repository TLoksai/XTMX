...
const AwardsList = [
  ...
  },
  {
    ...
    description: `In addition, xTRansmatrix has been honored with the Global AI Innovation Award from the Global Council of AI Entrepreneurs in 2024. This esteemed recognition celebrates our groundbreaking initiatives in artificial intelligence and highlights our commitment to leveraging AI technologies to overcome complex challenges and drive sustainable growth. Recognized by a global network of visionary AI entrepreneurs, this award underlines our dedication to pushing the boundaries of technology, redefining industry standards, and creating a future where AI catalyzes transformative change worldwide.`,
    image: "/images/recent-awards-recognition/2.png",
  },
  {
    title: "KDEM Recognition from Karnataka Digital Economy Mission",
    description: `Furthermore, we are honored to receive recognition from the Karnataka Digital Economy Mission (KDEM) for our exceptional efforts in creating employment opportunities beyond Bangalore. This accolade celebrates our pioneering initiative—the Mangaore AI Tech Workplace—which harnesses advanced AI technologies to drive job creation and foster digital transformation in emerging regions. By extending our impact well beyond the traditional tech hub of Bangalore, xTRansmatrix is committed to nurturing talent across broader geographies, empowering communities, and setting new benchmarks in the digital economy.`,
  ...
  },
  {
    ...
    description: `We are thrilled to announce that in 2024, xTRansmatrix received recognition from Product Tank for our thought leadership in agility and product mindset. This accolade underscores our commitment to cultivating an agile, customer-centric approach that drives innovative product solutions and industry transformation. Celebrated for our forward-thinking strategies and ability to inspire continuous improvement, this recognition reaffirms our role as change agents in shaping the future of product development and digital transformation.`,

const ContactSection = () => {
  return (
    <section className="relative flex justify-center px-6 md:px-16 lg:px-24 py-16 text-white">
      {/* Contact Button (Floating Above) */}
      <div className="absolute -top-4 md:-top-6 lg:-top-8 bg-[#6253A1] text-white px-6 py-3 rounded-full border-2 border-[#35A7E4] text-sm md:text-lg font-semibold">
        Contact
      </div>

      {/* Main Container */}
      <div className="w-full md:w-4/5 bg-black p-6 rounded-lg shadow-lg border-2 border-[#7F60ED] flex flex-col md:flex-row mt-8">

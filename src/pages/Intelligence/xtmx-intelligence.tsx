  ...
  return (
    <section className="bg-[#0a0214] text-white">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/images/xtmx-intelligence-banner.png')",
      ...
      <div className="max-w-screen-lg mx-auto px-6 md:px-12 py-16">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mt-8">
          ...
          <div className="md:w-1/3 flex justify-center">
            <img
              src="/images/intelligent-sme.png"
              alt="Intelligent SME"
        ...
        {/* Approach: Chain-Intelligent SMEs */}
        ...
        <div className="text-center mt-16">
          ...
          <ul className="list-disc text-gray-300 mt-6 space-y-3 pl-6 text-left mx-auto max-w-3xl">
            ...
            <li>
              <span className="text-white font-semibold">
                Smart Automation & AI-Driven Insights:
              </span>{" "}
